/**
 * Per-user getConfig cache with TTL and exponential-backoff retry.
 * Ported from openclaw-weixin src/api/config-cache.ts.
 */
...
export class WeixinConfigManager {
  ...
  constructor(
    ...
    private log: (msg: string) => void = console.debug,
  ) {}
